      ...
      {isModalOpen && (
        ...
        >
          ...
          <div
            ...
            className="relative w-full max-w-md sm:max-w-lg aspect-square bg-primary border-2 border-white/20 rounded-3xl shadow-2xl overflow-hidden p-6 animate-scaleUp"
          >
            <Image
              src={fixedImage.src}
              alt={fixedImage.alt}
